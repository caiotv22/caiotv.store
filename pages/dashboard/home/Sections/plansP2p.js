      ...
      translation: {
        pricing: {
          ...
          plans: {
            ...
            plan_1: {
              price_1: dataToObj?.translation?.pricing?.plans?.plan_1?.price_1,
              price_2: dataToObj?.translation?.pricing?.plans?.plan_1?.price_2,
              price_3: dataToObj?.translation?.pricing?.plans?.plan_1?.price_3,
            },
            plan_2: {
              price_1: getPrice1Plan ? getPrice1Plan : dataToObj?.translation?.pricing?.plans?.plan_2?.price_1,
              price_2: getPrice2Plan ? getPrice2Plan : dataToObj?.translation?.pricing?.plans?.plan_2?.price_2,
              price_3: getPrice3Plan ? getPrice3Plan : dataToObj?.translation?.pricing?.plans?.plan_2?.price_3,
            },
            default_features: {
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Input
          ...
          defaultVal={dataToObj?.translation?.pricing?.plans?.plan_2?.price_1}
        ...
        <Input
          ...
          defaultVal={dataToObj?.translation?.pricing?.plans?.plan_2?.price_2}
        ...
        <Input
          ...
          defaultVal={dataToObj?.translation?.pricing?.plans?.plan_2?.price_3}
